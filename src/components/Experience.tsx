      ...
      <div className="container mx-auto px-6">
        ...
        >
          <div className="relative">
            <div className="hidden md:visible absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-blue-400 to-purple-500"></div>
            ...
            <motion.div
              ...
              className="relative bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl border border-gray-700 hover:border-blue-400 transition-all duration-300 md:ml-16"
            >
              <div className="hidden md:visible absolute -left-20 top-8 w-8 h-8 bg-blue-500 rounded-full border-4 border-gray-900 items-center justify-center">
              ...
              <div className="flex flex-wrap items-center gap-4 mb-4">
                ...
                <div className="flex items-center text-gray-400">
                  ...
                  <span>2023 - Present (3+ years)</span>
                </div>
                <div className="flex items-center text-gray-400">
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <div className="grid md:grid-cols-2 gap-1 md:gap-6 mt-2 md:mt-6">
                  <div>
